...
Construction of DC Machine: ![][image1]  
 						EM1
...
*Permanent Magnet DC Generator*![][image3]  
EM3  
...
In these types of DC generators, the field windings are linked in parallel with the armature conductors, as indicated in the picture below. In shunt generators, the voltage in the field winding is identical to the voltage across the terminal.  
![][image6]  
					EM6
...
### Applications for Separately Excited DC Generators
...
### Applications for Shunt DC Generators
...
### Applications for Series DC Generators
...
### Applications for Compound DC Generators
...
* Pole Body: Pole body works with the pole core. When an [electric current](https://www.geeksforgeeks.org/physics/electric-current/) passes through the field winding, a magnetic flux is established not only in the pole core but also around it. The poles and their bearings are known as the pole body.  
...
![][image12]  
EM12  
When a current carrying conductor is placed in a magnetic field, a mechanical force acts on it, which can be determined by Fleming's left hand rule. Due to this force the conductor becomes mobile in the direction of the [force](https://www.geeksforgeeks.org/physics/force/).
...
Ns=120fPN\_s \= \\frac{120f}{P}Ns​=P120f​
...
s=Ns−NNss \= \\frac{N\_s \- N}{N\_s}s=Ns​Ns​−N​
...
Losses in AC machines are the power dissipations that reduce efficiency.  
They mainly occur due to current flow, magnetic effects, and mechanical motion.
