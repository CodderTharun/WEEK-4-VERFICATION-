...
A **Perceptron** is the simplest form of an Artificial Neural Network (ANN) that makes decisions by combining input values with corresponding weights and applying an activation function. It is primarily used for binary classification problems where the output belongs to one of two classes. The perceptron serves as the fundamental building block of more complex neural networks and deep learning models.

- Takes multiple inputs and assigns weights to each input.
- Computes a weighted sum of inputs and adds a bias term.
- Applies an activation (threshold) function to determine the output.
- Produces a binary output, typically 0 or 1.
- Learns by adjusting weights based on prediction errors.
- Forms the foundation of multilayer neural networks and deep learning architectures.

<img src="https://github.com/CodderTharun/images/blob/main/aiml3.8.png?raw=true" height="500" width="500" />

### Working of a Perceptron

1. Receive input values \(x_1, x_2, \ldots, x_n\).
2. Multiply each input by its corresponding weight \(w_1, w_2, \ldots, w_n\).
3. Add the weighted inputs along with a bias term \(b\).
4. Apply an activation function to the result.
...
- Cannot solve non-linear problems such as the XOR problem.
- Has limited representation power compared to multi-layer networks.
...
<img src="https://github.com/CodderTharun/images/blob/main/aiml3.9.png?raw=true" height="500" width="500" />
...
<img src="https://github.com/CodderTharun/images/blob/main/aiml3.10.png?raw=true" height="500" width="500" />
...
<img src="https://github.com/CodderTharun/images/blob/main/fnn.png?raw=true" height="500" width="100%" />
...
<img src="https://github.com/CodderTharun/images/blob/main/cnn.jpg?raw=true" height="500" width="100%" />
...
<img src="https://github.com/CodderTharun/images/blob/main/rnn.png?raw=true" height="500" width="100%" />
...
<img src="https://github.com/CodderTharun/images/blob/main/gan.png?raw=true" height="500" width="100%" />

### E. Long Short-Term Memory (LSTM)

This is a specialized type of Recurrent Neural Network (RNN) capable of learning long-term dependencies in sequential data. It solves the "vanishing gradient" problem of traditional RNNs by incorporating a memory cell and a gating mechanism that controls the flow of information.
<img src="https://github.com/CodderTharun/images/blob/main/lstm.png?raw=true" height="500" width="100%" />
...
<img src="https://github.com/CodderTharun/images/blob/main/tna.png?raw=true" height="500" width="100%" />
---
...
An optimizer is an algorithm used to adjust the weights and biases of a neural network during training in order to minimize the loss (error) function. It determines how the network learns from data by updating parameters based on the gradients calculated through backpropagation. The choice of optimizer significantly affects training speed, convergence and overall model performance.

### Importance of Optimizers

- Minimize the loss function efficiently.
- Improve model accuracy and convergence speed.
- Help neural networks learn optimal parameters.
...
2. Loss function calculates the error.
...
Gradient Descent is the fundamental optimization algorithm used to minimize the loss function by moving parameters in the direction opposite to the gradient.

#### Characteristics

- Uses the entire training dataset for each update.
- Produces stable gradient estimates.
- Computationally expensive for large datasets.
- Converges smoothly but slowly.
...
SGD updates model parameters after processing each training example individually instead of the entire dataset.

#### Characteristics

- Faster updates.
- Requires less memory.
- Introduces randomness into learning.
...
- Noisy updates.
- May oscillate near the optimum.

### 3. Mini-Batch Gradient Descent

Mini-Batch Gradient Descent is a compromise between Batch Gradient Descent and SGD. It updates parameters using small batches of training samples.
...
- Requires choosing batch size carefully.

### 4. Momentum Optimizer

Momentum improves Gradient Descent by adding a fraction of the previous update to the current update.

#### Characteristics

- Accelerates learning.
- Reduces oscillations.
- Helps move through shallow minima.
...
NAG is an improved version of Momentum that looks ahead before calculating gradients.

#### Characteristics

- Anticipates future parameter positions.
- Provides more accurate updates.
- Faster convergence than Momentum.

#### Advantages

- Improved optimization performance.
- Better handling of complex loss surfaces.
...
- Learning rate may become extremely small over time.

### 7. RMSProp (Root Mean Square Propagation)

RMSProp improves AdaGrad by preventing the learning rate from shrinking excessively.
...
Adam combines the advantages of Momentum and RMSProp. It is one of the most widely used optimizers in deep learning.
...
AdamW is a modified version of Adam that applies weight decay separately from gradient updates.
...
- Preferred optimizer for Transformer models.
- Reduces overfitting.
...
<img src="https://github.com/CodderTharun/images/blob/main/aiml3.11.png?raw=true" height="500" width="500" />
...
<img src="https://github.com/CodderTharun/images/blob/main/aiml3.12.png?raw=true" height="500" width="500" />
